  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p>Die Party findet im Haus von Simons Dad statt, der so nett war die Location zur Verfügung zu stellen! Danke an dieser Stelle!</p>
        <p>Adresse: <br/>
          bitte der WhatsApp Gruppe entnehmen<br/>
          <p>

            <p>Erreichbar mit der Bahn (S2, S7, REX) über die Station Neubau-Kreuzstetten. Vom Bahnhof ist es aber noch
              ein ziemlich weiter Fußweg, deshalb am besten mit einem Auto vom Bahnhof abholen lassen beziehungsweise
              generell Fahrgemeinschaften bilden!</p>
            ...
            <p>Es wird Smash Bros Ultimate für die Nintendo Switch gespielt, und zwar ein Turnier in einem Crew Battle
              ...
              aber für jedes Match anders sein. Falls ein Match 2-2 endet, kommt es zu einem Tiebreaker.</p>

            <p>Im Tiebreaker wird eine Runde Apfelsaft-Pong gespielt, wobei es nur einen Becher pro Team gibt und der
              erste Treffer das Spiel entscheidet. Um zu entscheiden, wer anfängt zu werfen, wird Schere-Stein-Papier
              auf
              zwei Unterschied gespielt. Die Spieler einer Crew müssen sich beim Werfen abwechseln.</p>

            <p>Das Turnier wird in einem Double Elimination Bracket ausgetragen. Das heißt, wenn man ein Match verliert,
              ...
              aus
              dem Winner Bracket gewinnen, um das Turnier zu gewinnen.</p>
            <h2 className={styles.title2}>Handicap</h2>
            <p>Um schwächeren Spielern eine Chance zu geben und die Matches spannender zu machen, gibt es ein
              ...
              der
              Tier List bestimmt. Beispiel: Ein High Tier(Tier 3) Spieler spielt gegen einen Low Tier(Tier 1) Spieler,
              der
              High Tier Spieler muss 2 Leben(3-1) opfern. Im 2vs2 gilt dies auch, Beispiel: Ein High Tier und ein Mid
              Tier
              Spieler spielen gegen einen Mid Tier und einen Low Tier: ersteres Team muss 2 = (3+2) - (2+1) Leben
              opfern.
              Das stärkere Team darf sich aussuchen, ob ein Spieler beide oder jeder Spieler eines opfert. Nach dem
              Opfern
              beginnt das Spiel sofort, das heißt, die Unverwundbarkeit nach dem Respawn darf ausgenutzt werden.</p>
            ...
            <p>PS: Es sind aber nicht alle Items und auch nicht alle Stages aktiviert. Da man die
