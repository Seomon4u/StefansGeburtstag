    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <p>
          ...
          der Tier List bestimmt. Beispiel: Ein High Tier(Tier 3) Spieler spielt gegen einen Low Tier(Tier 1) Spieler,
          der High Tier Spieler muss 2 Leben(3-1) opfern. Im 2vs2 gilt dies auch, Beispiel: Ein High Tier und ein Mid
          Tier Spieler spielen gegen einen Mid Tier und einen Low Tier: ersteres Team muss 2 = (3+2) - (2+1) Leben opfern.
          Das stärkere Team darf sich aussuchen, ob ein Spieler beide oder jeder Spieler eines opfert. Nach dem Opfern
          beginnt das Spiel sofort, das heißt, die Unverwundbarkeit nach dem Respawn darf ausgenutzt werden.
        </p>
        <h2 className={styles.title2}>Settings</h2>
        <p>
          Es ist ein Regelwerk mit dem Namen “Turnier” erstellt:<br/>
          Stocks: 3<br/>
          Match Time Limit: 15 min<br/>
          Friendly Fire: On<br/>
          Items: Low<br/>
          Stage Hazards: On<br/>
